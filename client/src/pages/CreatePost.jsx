...
function CreatePost() {
    ...
    const handleGenerateImage = async () => {
        // Access the backend, retrieve the AI generated image
        if (form.prompt) {
            try {
    ...
    return (
        <section className="max-w-7xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[16px] mx-w [500px]">Create imaginative and visually stunning images throuth DALL-E AI and share them with the community</p>
            </div>
            {/* placeholder for form */}
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-5">
                    {/* placeholder for formField components */}
                    <FormField
                        labelName="Your name"
                        type="text"
                        name="name"
